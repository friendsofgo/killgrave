import{_ as t,r as e,o,c as p,a as s,b as n,d as c,e as i}from"./app-GKjJbFgT.js";const u={},l=s("h1",{id:"use-json-schema",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#use-json-schema","aria-hidden":"true"},"#"),n(" Use JSON Schema")],-1),r={href:"https://json-schema.org/",target:"_blank",rel:"noopener noreferrer"},d=i(`<p>To do that you will need to define our <code>json schema</code> first:</p><p><em>e.g. <code>imposters/schemas/create_gopher_request.json</code></em></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
